...
class Pipsolar : public uart::UARTDevice, public PollingComponent {
  ...
  PIPSOLAR_BINARY_SENSOR(test_sen, QPIGS, char)
  ...
  PIPSOLAR_SENSOR(battery_cutoff_voltage2, QPIRI, float)
 ...
 protected:
  ...
  static const size_t PIPSOLAR_READ_BUFFER_LENGTH = 113;  // maximum supported answer length
